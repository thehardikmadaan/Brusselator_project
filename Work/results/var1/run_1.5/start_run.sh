...
#   3. duration       - Total simulation time in seconds (e.g., 30.0)
#   4. dt             - Time step size in seconds (e.g., 0.01)
#   5. write_interval - Time interval between writing output files in seconds (e.g., 1.0)
#   6. Ca             - Brusselator parameter Ca (e.g., 1.0)
#   7. Cb             - Brusselator parameter Cb (e.g., 1.5)
#   8. method         - Time integration method (rk4 or implicit) (e.g., rk4)
#   9. reactions      - Reaction toggle (on or off) (e.g., on)

../../bin/brusselator 40 40 30.0 0.01 1.0 1.0 1.5 rk4 on
