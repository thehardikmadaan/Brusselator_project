/*
Defines the GridInfo structure, which consolidates all spatial
dimensions, physical constants, and solver options. This structure is passed
throughout the application to configure the simulation.
*/
